    ...
    public class AnchorData
    {
        ...
        public AnchorData()
        {
            mSimpSonAB = new AnchorSCH[]
            {
                ...
                new PAB() { Name = "PAB7", Dia = 7/8d, de = 8.5, F = 13, Tension = 11970, fc = 3000},
                new PAB() { Name = "PAB8", Dia = 1d, de = 10.5, F = 16, Tension = 16435, fc = 3000},
                new PAB() { Name = "PAB9", Dia = 1+1/8d, de = 12, F = 18, Tension = 20255, fc = 3000},
                new PAB() { Name = "PAB10", Dia = 1+1/4d, de = 14, F = 21, Tension = 26190, fc = 3000},
